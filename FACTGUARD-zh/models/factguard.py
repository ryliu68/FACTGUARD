...
class FACTGUARDModel(torch.nn.Module):
    def __init__(self, config):
        ...
        # The following is a backbone experiment, which also needs to be changed to the corresponding Tokenizer in the dataloader.
        # self.bert_content = BertModel.from_pretrained("hfl/chinese-roberta-wwm-ext",ignore_mismatched_sizes=True).requires_grad_(False)
        # self.bert_FTR = BertModel.from_pretrained("hfl/chinese-roberta-wwm-ext",ignore_mismatched_sizes=True).requires_grad_(False)
