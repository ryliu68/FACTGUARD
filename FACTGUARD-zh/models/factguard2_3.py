...
class FACTGUARDModel(torch.nn.Module):
    ...
    Uses FTR_2 and FTR_3 features for prediction.
    """
    def __init__(self, config):
        super(FACTGUARDModel, self).__init__()

        # Load pretrained Bert models for FTR_2 and FTR_3 features
    ...
    def forward(self, **kwargs):
        ...
        # Cross attention between FTR_2 and FTR_3 features
        ...
        # Reweighting scores for experts
        ...
        # Aggregate all features for final prediction
    ...
    def train(self, logger = None):
        ...
        for epoch in range(self.config['epoch']):
            ...
            for step_n, batch in enumerate(train_data_iter):
                ...
                loss_hard_aux = loss_hard_aux_fn(res['hard_ftr_2_pred'], simple_ftr_3_label.float()) + \
                                loss_hard_aux_fn(res['hard_ftr_3_pred'], hard_ftr_3_label.float())
            
                loss_simple_aux_fn = torch.nn.CrossEntropyLoss()
                loss_simple_aux = loss_simple_aux_fn(res['simple_ftr_2_pred'], label.long()) + \
                                  loss_simple_aux_fn(res['simple_ftr_3_pred'], simple_ftr_3_label.long())
