...
class FACTGUARDModel(torch.nn.Module):
    ...
    def forward(self, **kwargs):
        ...
        content_masks = FTR_2_masks

        # Extract features using Roberta backbone
        content_feature = self.bert_FTR(FTR_2, attention_mask = FTR_2_masks)[0]
       
        # Content attention
        attn_content1, _ = self.content_attention(content_feature, mask=content_masks)
        attn_content2, _ = self.content_attention(content_feature, mask=content_masks)
