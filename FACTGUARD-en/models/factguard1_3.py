...
class FACTGUARDModel(torch.nn.Module):
    ...
    def forward(self, **kwargs):
        ...
        mutual_content_FTR_2, _ = self.cross_attention_content_2(content_feature_1, FTR_3_feature, content_masks)
        expert_2 = torch.mean(mutual_content_FTR_2, dim=1)
  
        mutual_FTR_content_2, _ = self.cross_attention_ftr_2(FTR_3_feature, content_feature_1, FTR_3_masks)
        mutual_FTR_content_2 = torch.mean(mutual_FTR_content_2, dim=1)
        
        mutual_content_FTR_3, _ = self.cross_attention_content_2(content_feature_1, FTR_3_feature, content_masks)
        expert_3 = torch.mean(mutual_content_FTR_3, dim=1)
  
        mutual_FTR_content_3, _ = self.cross_attention_ftr_2(FTR_3_feature, content_feature_1, FTR_3_masks)
        ...
        simple_ftr_2_pred = self.simple_mlp_ftr_2(self.simple_ftr_2_attention(FTR_3_feature)[0]).squeeze(1)
        ...
        gate_value = reweight_score_ftr_2
    ...
    def train(self, logger=None):
        ...
        for epoch in range(self.config['epoch']):
            ...
            for step_n, batch in enumerate(train_data_iter):
                ...
                loss_simple_aux = loss_simple_aux_fn(res['simple_ftr_2_pred'], simple_ftr_3_label.long()) 
